...
const MemoizedDesktopNav = React.memo(function DesktopNav() {
  return (
...
const MemoizedMobileNav = React.memo(function MobileNav() {
  return (
...
const MemoizedConnectButton = React.memo(function MemoizedConnectButton() {
  return (

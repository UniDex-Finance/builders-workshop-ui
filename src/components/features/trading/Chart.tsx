    ...
    try {
      ...
      const widget = new window.TradingView.widget({
        ...
        overrides: {
          ...
          "paneProperties.background": theme === 'greenify' ? "#0c1012" : theme === 'light' ? "#ffffff" : theme === 'hotline' ? "#0f0c2c" : theme === 'oled' ? "#000000" : "#141414",
          "scalesProperties.backgroundColor": theme === 'greenify' ? "#0c1012" : theme === 'light' ? "#ffffff" : theme === 'hotline' ? "#0f0c2c" : theme === 'oled' ? "#000000" : "#141414",
        },

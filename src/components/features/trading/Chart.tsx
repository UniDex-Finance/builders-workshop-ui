    ...
    try {
      ...
      const widget = new window.TradingView.widget({
        ...
        overrides: {
          ...
          "paneProperties.background": theme === 'greenify' ? "#0c1012" : theme === 'light' ? "#ffffff" : theme === 'hotline' ? "#0f0c2c" : "#17161d",
          "scalesProperties.backgroundColor": theme === 'greenify' ? "#0c1012" : theme === 'light' ? "#ffffff" : theme === 'hotline' ? "#0f0c2c" : "#17161d",
        },

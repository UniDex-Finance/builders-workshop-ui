            ...
            <div className="flex items-center space-x-8 px-4 border-r min-w-[300px]">
              <TooltipProvider>
                <Tooltip>
                  ...
                  <TooltipContent className="z-50 p-4 rounded-md shadow-lg border border-border/40 bg-[#141414]/80 backdrop-blur-md">
              ...
              <div className="flex gap-4">
                <TooltipProvider>
                  <Tooltip>
                    ...
                    <TooltipContent className="z-50 w-[300px] p-4 rounded-md shadow-lg border border-border/40 bg-[#141414]/80 backdrop-blur-md">
